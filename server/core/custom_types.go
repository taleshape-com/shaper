...
var dbTypes = []struct {
	...
	{"SCATTERPLOT", "UNION(\"scatterplot_interval\" INTERVAL, \"scatterplot_double\" DOUBLE)", "chart"},
	{"SCATTERPLOT_PERCENT", "UNION(\"scatterplot_percent_double\" DOUBLE)", "percent"},
	{"SCATTERPLOT_CATEGORY", "UNION(\"scatterplot_category_varchar\" VARCHAR)", "string"},
	...
	{"SCATTERPLOT_COLOR", "UNION(\"scatterplot_color_varchar\" VARCHAR)", "string"},
