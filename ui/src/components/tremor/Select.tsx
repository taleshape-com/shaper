...
const selectTriggerStyles = [
  cx(
    // base
    "group/trigger flex w-full select-none items-center justify-between gap-2 truncate rounded-md border px-2 py-1.5 transition text-sm font-normal",
    // border color
...
>(
  (
    ...
    <SelectPrimitives.Portal container={document.querySelector(".shaper-scope") === document.querySelector("html") ? document.body : document.querySelector(".shaper-scope")}>
