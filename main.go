...
func loadConfig() Config {
	...
	taskResultConsumerName := flags.StringLong("task-result-consumer-name", "shaper-task-result-consumer", "Name for the task result consumer")
	...
	config := Config{
		...
		TaskQeueConsumerName:     *taskQueueConsumerName,
