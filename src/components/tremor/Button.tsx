...
const buttonVariants = tv({
  base: [
    // base
    "relative inline-flex items-center justify-center whitespace-nowrap rounded-md border px-2 py-1 text-center text-sm font-medium transition-all duration-100 ease-in-out",
    // disabled
